#namespace("crm.business")
    ...
    #sql ("queryProduct")
    select b.product_id,b.name as productName,c.name as category_name,b.单位 as unit,a.price,a.sales_price,a.num,a.discount,a.subtotal,b.是否上下架
    ...
    where a.create_user_id = b.user_id and types = 'crm_business' and types_id = ? order by a.create_time desc
    #end
