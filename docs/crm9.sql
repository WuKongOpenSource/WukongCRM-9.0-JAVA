...
DROP TRIGGER IF EXISTS `oa_record`;
DELIMITER ;;
CREATE TRIGGER `oa_record` AFTER DELETE ON `72crm_oa_log` FOR EACH ROW begin
    delete from snowerp_oa_action_record where action_id = OLD.log_id and type = 1;
  end
;;
DELIMITER ;
